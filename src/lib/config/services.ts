...
export const services: ServiceDefinition[] = [
  {
    ...
    included: {
      fr: [
        'Cuisine : comptoirs, évier et robinet, dessus de la cuisinière, extérieur des électroménagers, micro-ondes (intérieur et extérieur), dosseret visible, table accessible, poubelle et plancher',
        'Salles de bain : toilette au complet, lavabo et vanité, miroir, douche/bain, robinetterie, surfaces accessibles, poubelle et plancher',
        'Chambres : surfaces accessibles, époussetage, miroir, lit remis en ordre si accessible, poubelle et plancher',
        'Salon et salle à manger : surfaces accessibles, époussetage, meubles et tables, miroirs, coussins remis en place, poubelles et plancher',
        'Général : entrée, corridors, escaliers, aspirateur, lavage des sols durs, et retrait des traces évidentes sur poignées et interrupteurs',
      ],
      en: [
        'Kitchen: counters, sink and faucet, stovetop, exterior of appliances, microwave (inside and out), visible backsplash, accessible table, trash, and floor',
        'Bathrooms: toilet (full), sink and vanity, mirror, shower/tub, fixtures, accessible surfaces, trash, and floor',
        'Bedrooms: accessible surfaces, dusting, mirror, bed straightened up if accessible, trash, and floor',
        'Living & dining rooms: accessible surfaces, dusting, furniture and tables, mirrors, cushions tidied, trash, and floors',
        'General: entryway, hallways, stairs, vacuuming, hard floors washed, and obvious marks removed from handles and light switches',
      ],
    },
    whoFor: {
      fr: [
  ...
  },
  {
    ...
    included: {
      fr: [
        ...
        'Plinthes lavées, rebords et cadres de portes accessibles',
        'Façades d’armoires et poussière accumulée en hauteur et dans les coins',
        'Dessous des meubles accessibles, coins et bordures',
        'Ventilateurs et luminaires accessibles',
        'Cuisine plus détaillée et dégraissée, salle de bain plus détaillée (joints, robinetterie)',
      ],
      en: [
        'Everything included in regular cleaning',
        'Baseboards washed, accessible ledges and door frames',
        'Cabinet fronts and accumulated dust at height and in corners',
        'Underneath accessible furniture, corners and edges',
        'Accessible ceiling fans and light fixtures',
        'A more detailed, degreased kitchen and a more detailed bathroom (grout, fixtures)',
      ],
    },
    whoFor: {
      fr: [
    ...
    benefits: {
      fr: [
        ...
        'Intérieur du four, du frigo et des armoires disponibles en extras au besoin',
      ...
      en: [
        ...
        'Inside oven, fridge and cabinets available as extras if you need them',
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          fr: 'Oui, vous pouvez ajouter des extras comme l’intérieur du four, du réfrigérateur, des armoires ou des fenêtres directement dans le formulaire de réservation.',
          en: 'Yes, you can add extras like the inside of the oven, fridge, cabinets, or windows directly in the booking form.',
        },
      },
    ],
  },
  {
    ...
    included: {
      fr: [
        'Tout ce qui est inclus dans le ménage en profondeur',
        'Intérieur des armoires et tiroirs, une fois vides',
        'Garde-robes vides',
        'Intérieur du four',
        'Intérieur du réfrigérateur',
        'Surfaces auparavant bloquées par des meubles, lorsqu’accessibles, et traces légères sur les murs lorsque cela peut être fait de façon sécuritaire',
        'Inspection finale avant remise des clés',
      ],
      en: [
        'Everything included in deep cleaning',
        'Inside cabinets and drawers, once emptied',
        'Empty closets',
        'Inside the oven',
        'Inside the refrigerator',
        'Surfaces previously blocked by furniture, where reachable, and light wall marks where it’s safe to do so',
        'A final walkthrough before the keys change hands',
      ],
    },
    whoFor: {
      fr: [
